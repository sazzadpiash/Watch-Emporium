                ...
                <div className="mx-auto container">
                    ...
                    <div className="mt-12 lg:mt-24">
                        <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                            <div>
                                <img className="w-full" src="https://cdn.shopify.com/s/files/1/1692/8885/articles/blog4.jpg?v=1485167450" alt="computer" />
                                <div className="py-4 px-8 w-full flex justify-between bg-black">
                            ...
                            <div>
                                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                                    <div>
                                        <img className="w-full" src="https://cdn.shopify.com/s/files/1/2496/9194/articles/blog12.jpg?v=1509972401" alt="games" />
                                        <div className="py-2 px-4 w-full flex justify-between bg-black">
                                            <p className="text-sm text-white font-semibold tracking-wide">Bruce Wayne</p>
                                            <p className="text-sm text-white font-semibold tracking-wide">13TH Oct, 2020</p>
                                        </div>
                                    ...
                                    <div>
                                        <img className="w-full" src="https://cdn.shopify.com/s/files/1/2496/9194/articles/blog8.jpg?v=1509972395" alt="notes" />
                                        <div className="py-2 px-4 w-full flex justify-between bg-black">
                                            <p className="text-sm text-white font-semibold tracking-wide">Bruce Wayne</p>
                                            <p className="text-sm text-white font-semibold tracking-wide">13TH Oct, 2020</p>
                                        </div>
